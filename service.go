...
//go:generate mockery --output C:\Users\Disti\go\src\golang-training-2021-10-tests\internal\mock --outpkg mock --name=Repository
type Repository interface {
	Load(string) (model.Price, bool)
	Store(string, model.Price)
}
//go:generate mockery --output C:\Users\Disti\go\src\golang-training-2021-10-tests\internal\mock --outpkg mock --name=HTTPClient
